...
% Editor : Moyo Ajayi
% Github : https://github.com/907_Resident
%------------------------
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{{\LARGE Moyo Ajayi}} & Email: \href{mailto:}{moyo.ajayi.ds@gmail.com}\\
  %\href{https://xprilion.com}{Portfolio: xprilion.com} & Mobile:+1 907.306.2651 \\
  \href{https://github.com/907_Resident}{Github: ~~github.com/907_Resident} \\
\end{tabular*}
...
\section{Skills Summary}
	\resumeSubHeadingListStart
	\resumeSubItem{Languages}{~~~~~~Python, R, HTML \& CSS, Matlab}
	\resumeSubItem{Frameworks}{~~~~Scikit-Learn, NLTK, SpaCy, TensorFlow, Keras, Pandas, Flask, NodeJS, LAMP}
	\resumeSubItem{Tools}{~~~~~~~~~~~~~~Git, Docker, PostgreSQL}
	\resumeSubItem{Platforms}{~~~~~~~Linux/Unix, Windows, AWS, Azure, Databricks, Strea}
	\resumeSubItem{Intangible Skills}{~~~~~~~Leadership, Event Management, Writing, Public Speaking, Time Management}
