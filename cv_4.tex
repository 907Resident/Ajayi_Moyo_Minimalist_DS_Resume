...
\begin{rSection}{Relevant Experience}
    ...
    \begin{rSubsection}{Bridgestone}{August 2022 - Present}{Senior Data Scientist}{Denver, CO} 
        ...
        \vspace{-0.5em}
        \subitem {$\cdot$ Leaped ahead of previous process and simple sentiment classification by building a collection of \\ \hspace*{2.25em} transformer-based models that work in concert to provide deterministic predictions of customer \\ \hspace*{2.25em} feedback across \(\geq\)16 actionable categories}        
        \vspace{-0.5em}
    ...
    \item {Global Climate Forecasting Reporting Tool}
        \vspace{-0.5em}
        \subitem{$\cdot$ Developed multi-layered tool to query, quantify, and automatically report current and projected data \\ \hspace*{2.25em} for a financial institution and its agribusiness assets}
        \vspace{-0.5em}
